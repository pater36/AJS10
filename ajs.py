...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='EzDDPRUXB1dnDYwo0uOc.Uv/0YYcEoAwu5rWj4Sx9Ja.bYLH945Es4rQX1JNsTBEiZ9/aRgj0QqxSK5zxY+55vc=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

#ki = LineClient()
ko = LineClient(authToken='EzaHg16bwMAFoXyghwuf.XzmbAwonn5keEY4vw/uKlW.n3Nlro4HmaoffvB4KUsqs0I9htp9R1Zg/Zt1etIN6DM=')
ko.log("Auth Token : " + str(ko.authToken))
channel1 = LineChannel(ko)
ko.log("Channel Access Token : " + str(channel1.channelAccessToken))

#kk = LineClient()
kk = LineClient(authToken='EzrWFigBwa8n1srAIWI0.9T/PGPFdadrWbCl3Gzx/Ga.T8p3dY9X9jsaj2ohiCBRTIw0R9BiV2getGu14wb6BvE=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

#kc = LineClient()
kc = LineClient(authToken='Ez0h8egbUfct5Nighztd.tLlReCirgG96uB+Q5pwO+q.5kJWBql17ZkUfkpqDuVDqhIXqMJthWn672wY4AduK9s=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

#ke = LineClient()
ke = LineClient(authToken='Eza7zvz1nGjzL1ptNcD1.lXZ4ob/KwrCUJfHRJ603qq.k32IodoRelaNHT/S9aCoOyhK0GroHH1T79MdlITP5fw=')
ke.log("Auth Token : " + str(ke.authToken))
channel4 = LineChannel(ke)
ke.log("Channel Access Token : " + str(channel4.channelAccessToken))

#kf = LineClient()
kf = LineClient(authToken='EzSutQzia1ytMdlCliS6.BaiKNxR2VN7zWCBrQS6P5G.C9nAjKGe5OfL8iIBqm56uMwP5LZR8PPe6oEsRDeYN/4=')
kf.log("Auth Token : " + str(kf.authToken))
channel5 = LineChannel(kf)
kf.log("Channel Access Token : " + str(channel5.channelAccessToken))

#kg = LineClient()
kg = LineClient(authToken='EzUGGkWzG081aC4wJAVa.UHbbg4pHBjT5VwCYtXmXsG.m9Ws8BcavIXIfrnt3pjZFNfilHQzwxtH8K6NEtXANvg=')
kg.log("Auth Token : " + str(kg.authToken))
channel6 = LineChannel(kg)
kg.log("Channel Access Token : " + str(channel6.channelAccessToken))

#kh = LineClient()
kh = LineClient(authToken='Ezm8zJglZWAPUMAcfKYa.Oyj1ZAWaMt3CKaVDd5BW2G.rXSqFqbh+yUrJ7oYiNloFU84MmUYIEGjpUudVX1g3bM=')
kh.log("Auth Token : " + str(kh.authToken))
channel7 = LineChannel(kh)
kh.log("Channel Access Token : " + str(channel7.channelAccessToken))

#ki = LineClient()
ki = LineClient(authToken='EzE2d57ik2ZZZN6b6aU4.UFxlUs4U2EOQjGvMmvWMDa.ziRvEQdQQjVrstL+EAJw0TUukCWFSRi8tX1NhGGsy4E=')
ki.log("Auth Token : " + str(ki.authToken))
channel8 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel8.channelAccessToken))

#kj = LineClient()
kj = LineClient(authToken='Ez7COPIdPXUJIODZW8F4.9UGdRKZXRTi7Enfms1+LPa.955pMFrohrRfvRXNYl/jQDFLNsQH0vDXDPgcR8FYjig=')
kj.log("Auth Token : " + str(kj.authToken))
channel9 = LineChannel(kj)
kj.log("Channel Access Token : " + str(channel9.channelAccessToken))

#sw = LineClient()
sw = LineClient(authToken='EzLZJVTXm6wkh74DPpOb.zr+MvMh78HjcGGT1M17UEW.lH1olrk1iGfkjI+sSd8f3Jn+Rp7mJvgLyVImU2BmMAo=')
